...
const ContactUs = () => {
  return (
    <div className="font-serif">
      <div className="p-4 md:p-12 md:pl-24 md:pr-24 pb-36">
        <h1 className="text-4xl md:text-6xl font-bold text-center mb-10 text-orange-300">Contact Us</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-8">
            <div className="flex items-center space-x-4">
              <FaPhone className="text-blue-500" size={36} />
              <span className="text-lg p-5 md:text-xl">+91 9990277066</span>
            </div>
            <div className="flex items-center space-x-4">
              <FaEnvelope className="text-green-500" size={36} />
              <span className="text-lg p-5 md:text-xl">dr.kopalsingh21@gmail.com</span>
            </div>
            <div className="flex items-center space-x-4">
              <FaMapMarkerAlt className="text-red-500" size={36} />
              <span className="text-lg p-5 md:text-xl">
                E-333/4, Khosla Market, <br />
                Opp Mahesh Apt, <br />
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-lg p-5 flex space-x-4">
          ...
          <div className="flex items-center justify-center">
            <a href="https://www.google.com/maps/dir//vasundhara+dental+home/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x390ce56728aaf793:0xa7ebca477d53b386?sa=X&ved=1t:3061&ictx=111" target="_blank" rel="noopener noreferrer">
              <img
                src={loc}
                alt="Location Map"
      ...
      <div className='text-center bg-red-200 p-8'>
        <h4 className='text-2xl'><u>NOTE</u></h4>
